...
export default function PrivacyPolicy(): JSX.Element {
  ...
  return (
    <div className="container">
      <section className="tile [&_h2]:mb-1 [&_h2]:mt-5 [&_p]:mb-2">
        ...
        <ul>
          ...
          <li>
            ...
            o przeglądarce, systemie operacyjnym).
          </li>
        </ul>
        ...
        <p>
          Szczegółowe informacje na temat wykorzystywanych plików cookies oraz
          zarządzania zgodą znajdują się poniżej:
        </p>
